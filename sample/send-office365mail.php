...
$accessToken        = isset($_SESSION['ms_access_token'])  ? $_SESSION['ms_access_token']  : null;   // real use case get this from db
$refreshToken       = isset($_SESSION['ms_refresh_token']) ? $_SESSION['ms_refresh_token'] : null;   // real use case get this from db
...
<head>
    <title>Office 365 - Send mail</title>
</head>
...
<body>
    ...
    try {
        ...
        sendOffice365Mail($email, $accessToken, $mailTo); 
